			...
			<div class="text-center container">
				<form class="form-inline" action="OnlineReservation" method="post">
					<div class="form-group">
						<label for="DepartureCity" class="blck"><b>From : </b></label> <input type="text" name="DepartureCity"
							class="form-control" placeholder="Enter country name..">
					</div>
					<div class="form-group pl-3 pr-1">
						<label for="ArrivalCity" class="blck"><b>To : </b></label> <input type="text" name="ArrivalCity"
							class="form-control" placeholder="Enter country name..">
					</div>
